...
async def start_cmd(message: types.Message):
    ...
    if not is_subscribed:
        await message.answer("❗ Чтобы пользоваться ботом, подпишитесь на наш канал: @krabamoreblg")
        return

    await message.answer("""
👋 <b>Приветствуем в 🦀 Краба Море!</b>
Чем бы вы хотели себе порадовать сегодня?
...
🛒 Заказать в WhatsApp — быстрый заказ  
🎁 Акции — уточните актуальные предложения  
